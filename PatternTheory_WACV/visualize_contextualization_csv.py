...
def getEquivalence(item, cnet):
	equivalent = {}
	try:
		obj = cnet.query_concept(item)
		print(len(obj))
...
def getPrior(item, other, cnet):
	priors = []
	concepts = []

	obj = cnet.query_edge(item, other)
	if not obj:
		return 0
...
# grounded_gens = [('butter','butter')]#,('spoon','butter'),('butter','egg'),('butter','pan'),('butter','topping'),('butter','plate'),('butter','pancake'),('smear','egg'),('smear','pancake'),('butter','flour'),('butter','dough')
